...
class SimpleSAML_Session implements Serializable
{
    ...
    {
    	//$testfunction = ['\SimpleSAML\module\memcookie\AuthMemCookie','test'];
    	//call_user_func($testfunction);
    	//\SimpleSAML\module\memcookie\AuthMemCookie::test();
        ...
        foreach ($this->authData[$authority]['LogoutHandlers'] as $handler) {
            ...
            if (!is_callable($handler)) {
                ...
                //error_log("Handler is not callable! Handler: ".join('|',$handler));
